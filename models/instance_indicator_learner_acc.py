...
class MeanTeacherLearner(nn.Module):
    def __init__(self, num_classes, num_samples, indicator_initialization=0.0, ema_decay=0.99, hyper_criterion_cfg=None,
    ...
    def grad_per_sample_classifier(self, image, target, copy_parameters=False):
        """
