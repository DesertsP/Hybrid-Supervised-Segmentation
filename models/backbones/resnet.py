...
class ResNet(nn.Module):
    def __init__(
        ...
        self.maxpool = nn.MaxPool2d(
            kernel_size=3, stride=2, padding=1, return_indices=False, ceil_mode=True
        )  # change
...
def resnet18(pretrained, **kwargs):
    ...
    if isinstance(pretrained, (str,)):
        model_urls["resnet18"] = pretrained
    if pretrained:
...
def resnet34(pretrained, **kwargs):
    ...
    if isinstance(pretrained, (str,)):
        model_urls["resnet34"] = pretrained
    if pretrained:
...
def resnet50(pretrained, **kwargs):
    ...
    if isinstance(pretrained, (str,)):
        model_urls["resnet50"] = pretrained
    if pretrained:
...
def resnet101(pretrained, **kwargs):
    ...
    if isinstance(pretrained, (str,)):
        model_urls["resnet101"] = pretrained
    if pretrained:
...
def resnet152(pretrained, **kwargs):
    ...
    if isinstance(pretrained, (str,)):
        model_urls["resnet152"] = pretrained
    if pretrained:
